...
#             # Normalize IN time
#             if isinstance(in_time_val, str):
#                 in_time_val = datetime.strptime(in_time_val, "%H:%M:%S").time()
#             elif isinstance(in_time_val, datetime):
#                 in_time_val = in_time_val.time()

#             # Normalize OUT time
#             if isinstance(out_time_val, str):
#                 out_time_val = datetime.strptime(out_time_val, "%H:%M:%S").time()
#             elif isinstance(out_time_val, datetime):
#                 out_time_val = out_time_val.time()
